<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"C:\phpStudy\PHPTutorial\WWW\pishop/./app/admin\view\index\index.html";i:1535432197;s:61:"C:\phpStudy\PHPTutorial\WWW\pishop\app\admin\view\layout.html";i:1524489111;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script>
        $('#clearCache').click(function(event) {
            ...
            $.get('<?php echo pishop_url('admin/config/cleanCache'); ?>', function(data) {
                if(data.code==1){
                    layer.msg(data.msg, {
                      icon: 6
                      ,shade: 0.01,
